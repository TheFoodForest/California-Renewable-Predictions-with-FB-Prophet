...
// get the slider
// checks object updated with each check and uncheck of the boxes on the home page
// will use this to determine what sections of day to show in solar plot in the checkFunction below
var checks = {'morning':false,
             'midDay':false,
            'evening':false}


function checkFunction(id, checked) {
    checks[`${id}`] = checked // object updated
